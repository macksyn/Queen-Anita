...
\x20\x20Prefix  : [${Config.HANDLERS}]
\x20\x20Plugins : ${events.commands.length}
\x20\x20Mode    : ${Config.WORKTYPE}
\x20\x20Database:  ${(isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "Lussh Default")}`;
      try {
