      ...
      if (_0x76cd91 === "all") {
        ...
        try {
          if (_0x188cac[_0x76cd91]) {
            ...
            _0x3d202e += "*_plugin does not exist in " + Config.botname + "_*";
          }
        } catch (_0x133006) {
...
note.delnote = async (_0x32bcc1, _0x2c426a) => {
  try {
    ...
    return {
      status: false,
      error: _0x36227d,
      msg: "*An Error Occured, Note could Not Be Deleted!!*"
    };
  }
};
note.delallnote = async (_0x3ac5ea, _0x5f348f = "") => {
  try {
    ...
    return {
      status: false,
      error: _0x21ccce,
      msg: "*Request could not proceed, Sorry!*"
    };
  }
};
...
setMention.cmd = async (_0x501ec5, _0x2a1c43 = "") => {
  try {
    ...
    if (_0x2a1c43 === "get" || _0x2a1c43 === "info" || !_0x2a1c43 && _0x22516b.status && _0x22516b.get) {
      ...
      _0x501ec5.reply("_Read wiki to set mention message https://github.com/macksyn/Lussh-AI/wiki/mention_", {}, "smd");
...
setFilter.set = async (_0x7cffc5, _0x172f0c = "") => {
  try {
    ...
    _0x7cffc5.send("*Filter Has Been Successfully Set To '" + _0x27ba2d + "'!*");
  } catch (_0x152f1f) {
...
setFilter.stop = async (_0x103724, _0xc4e239 = "") => {
  try {
    if (!_0xc4e239) {
      return _0x103724.send("*Provide A Word To Your Filter List!*\n*Use " + prefix + "flist to get list of filtered words!*");
    }
    ...
    if (!_0x23f901[_0xc4e239]) {
      return _0x103724.reply("*Given Word ('" + _0xc4e239 + "') is not in your filter list!*");
    }
