const {
 ...
 cmd({
   ...
   try {
     ...
     if (_0x4fbd42) {
       ...
       if (!_0x1df1fa) {
         _0x543a19 = "*❲❒❳ Reason:* _I Can't Kick Common Participants Without Getting Admin Role,So Make Me An Admin First,_\n";
       }
       if (!_0x16096e) {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x23d1da) {
       return await _0x3d5ec9.reply("*_Uhh Dear, Please Provide A User._*");
     }
     try {
 ...
 cmd({
   ...
   try {
     ...
     return await _0x553d05.reply("*Successfully Sent Broadcast To " + _0x4ef191.length + " Group*");
   } catch (_0x2a8ad8) {
